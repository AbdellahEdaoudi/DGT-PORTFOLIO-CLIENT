        ...
        <div className="space-y-4 md:space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 relative">
            ...
            {showConfirmModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <div className="bg-slate-900 border border-purple-500/20 rounded-2xl p-5 md:p-6 max-w-md w-full shadow-2xl animate-in zoom-in-95 duration-200">
            ...
            {/* Header */}
            <div className="bg-gradient-to-r from-indigo-900/40 to-purple-900/40 border border-purple-500/20 rounded-xl p-4 md:p-6 backdrop-blur-sm">
                <div className="flex items-center gap-3 md:gap-4">
                    <div className="p-2 md:p-3 bg-indigo-500/20 rounded-lg">
                        <Mail className="w-6 h-6 md:w-8 md:h-8 text-indigo-400" />
                    </div>
                    <div>
                        <h2 className="text-lg md:text-2xl font-bold text-white">Bulk User Messaging</h2>
                        <p className="text-xs md:text-sm text-gray-400">Send updates, announcements, or specialized offers to multiple users at once.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
                ...
                <div className="lg:col-span-2 space-y-4 md:space-y-6">
                    {/* Recipients Section */}
                    <div className="bg-slate-900/50 border border-purple-500/20 rounded-xl p-4 md:p-6">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mb-4">
                            ...
                            <button
                                onClick={addAllUsers}
                                className="text-xs bg-purple-500/20 hover:bg-purple-500/30 text-purple-300 px-3 py-1.5 rounded-lg transition border border-purple-500/30 w-full sm:w-auto"
                            >
                                + Add All Users
                            </button>
                        </div>
                        <textarea
                            ...
                            className="w-full h-32 bg-slate-950/50 border border-purple-500/20 rounded-lg p-3 md:p-4 text-white placeholder-gray-500 focus:outline-none focus:border-purple-500/50 resize-none font-mono text-xs md:text-sm"
                        />
                        <div className="mt-2 text-xs text-gray-500 flex flex-col sm:flex-row justify-between gap-1">
                    ...
                    {/* Content Section */}
                    <div className="bg-slate-900/50 border border-purple-500/20 rounded-xl p-4 md:p-6 space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-slate-950/50 border border-purple-500/20 rounded-lg px-3 py-2 md:px-4 md:py-3 text-sm md:text-base text-white placeholder-gray-500 focus:outline-none focus:border-purple-500/50 transition"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            {previewMode ? (
                                <div className="w-full h-[300px] md:h-[400px] bg-white text-black p-4 md:p-6 rounded-lg overflow-auto border border-gray-700">
                                    <div dangerouslySetInnerHTML={{ __html: content || "<p style='color: gray; text-align: center'>No content to preview</p>" }} />
                                </div>
                            ) : (
                                <div className="h-[300px] md:h-[400px] border border-purple-500/20 rounded-lg overflow-hidden">
                                    <Editor
                                        height="100%"
                ...
                <div className="space-y-4 md:space-y-6">
                    <div className="bg-slate-900/50 border border-purple-500/20 rounded-xl p-4 md:p-6 lg:sticky lg:top-24">
                        ...
                        <div className="space-y-3">
                            <button
                                ...
                                className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold py-2.5 md:py-3 px-4 rounded-xl transition shadow-lg shadow-purple-900/20 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm md:text-base"
                            >
                                {sending ? (
                                    <>
                        ...
                        <div className="mt-6 md:mt-8 border-t border-purple-500/20 pt-4 md:pt-6">
