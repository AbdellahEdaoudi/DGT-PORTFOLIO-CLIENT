...
export default function Theme4({ userDetails, userLinks }) {
                      ...
                      <div className="p-4 md:p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                        {(userDetails.displayEmail || userDetails.email) && (
                          <div className="flex gap-2 items-start">
                            ...
                            <a href={`mailto:${userDetails.displayEmail || userDetails.email}`} className="text-gray-300 hover:text-emerald-300 transition break-all">{userDetails.displayEmail || userDetails.email}</a>
                          </div>
                        )}
                        {userDetails.country && (
                          <div className="flex gap-2 items-start">
