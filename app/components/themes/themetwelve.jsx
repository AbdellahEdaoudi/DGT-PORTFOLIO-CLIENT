...
export default function ThemeTwelve({ userDetails, userLinks }) {
            ...
            {userDetails && (
                <div dir={userDetails?.displayLanguage === 'ar' ? 'rtl' : 'ltr'} className="min-h-screen bg-slate-950 text-white overflow-hidden">
                    ...
                    <div className="px-4 md:px-6">
                        ...
                        <header className="pt-7 pb-12">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        {activeSectionsCount >= 3 && (
                                            <button
                                                ...
                                                className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-blue-500/20 rounded-lg text-white transition-all duration-300 backdrop-blur-md border border-white/10 hover:border-blue-500/50 font-medium"
                                            >
                                                <Menu size={20} />
                                            </button>
                                        )}
                                                ...
                                                return sectionOrder
                                                    ...
                                                    .map((tab, index) => (
                                                        <button
                                                            ...
                                                            className={`group relative flex flex-col items-center justify-center p-6 md:p-8 gap-4 bg-white/5 hover:bg-blue-500/10 border border-white/10 rounded-3xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:border-blue-500/30
                          ...
                          `}
                                ...
                                <div className="flex flex-col-reverse md:flex-row gap-12 md:items-start items-center justify-between">
                                    <div className="">
                                        <p className="text-blue-400 font-semibold uppercase tracking-widest mb-3 text-sm">{t('helloIm')}</p>
                                        <h1 className="text-5xl md:text-6xl font-black mb-5">{userDetails?.fullname}</h1>
                                        <p className="text-2xl text-blue-300 font-semibold mb-5 flex items-center gap-2">
                                            ...
                                            <div className="p-4 md:p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                                                {(userDetails.displayEmail || userDetails.email) && (
                                                    <div className="flex gap-2 items-start">
                                                        <span className="font-bold text-blue-400 whitespace-nowrap">Email:</span>
                                                        <a href={`mailto:${userDetails.displayEmail || userDetails.email}`} className="text-gray-300 hover:text-blue-300 transition break-all">{userDetails.displayEmail || userDetails.email}</a>
                                                    </div>
                                                )}
                                                {userDetails.country && (
                                                    <div className="flex gap-2 items-start">
                                                        <span className="font-bold text-blue-400 whitespace-nowrap">{t('country')}:</span>
                                                        <span className="text-gray-300">{userDetails.country}</span>
                                                    </div>
                                                )}
                                                {userDetails.phoneNumber && (
                                                    <div className="flex gap-2 items-start">
                                                        <span className="font-bold text-blue-400 whitespace-nowrap">{t('phone')}:</span>
                                    ...
                                    <div className="relative flex-shrink-0 group">
                                        <div className="absolute inset-0 bg-gradient-to-br from-blue-500/30 to-blue-500/30 rounded-3xl blur-3xl group-hover:blur-2xl transition-all duration-500"></div>
                                        <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 to-blue-500 rounded-3xl opacity-20 group-hover:opacity-40 transition-opacity duration-500"></div>
                                        <Image width={320} height={320} priority
                                            src={userDetails?.urlimage}
                                            alt={userDetails?.fullname || "Profile"}
                                            className="relative rounded-3xl border-2 border-blue-500/40 group-hover:border-blue-500/60 transition-all duration-500 shadow-2xl w-56 h-56 md:w-80 md:h-80 object-cover"
                                        />
                                    </div>
                                </div>
                                ...
                                const sectionContent = {
                                            ...
                                            <div className="max-w-5xl mx-auto">
                                                ...
                                                <div className="grid md:grid-cols-2 gap-6">
                                                    {userDetails.services.map((service, i) => (
                                                        <div key={i} className="group p-6 bg-gradient-to-br from-blue-500/10 to-blue-500/10 border border-blue-500/30 rounded-xl hover:border-blue-500/60 hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300">
                                            ...
                                            <div className="max-w-5xl mx-auto">
                                                ...
                                                <div className="space-y-6">
                                                    {userDetails.experience.map((exp, i) => (
                                                        <div key={i} className="group relative p-6 bg-gradient-to-br from-blue-500/10 to-blue-500/10 border border-blue-500/30 rounded-xl hover:border-blue-500/60 hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300 overflow-hidden">
                                                            {/* Decorative element */}
                                                            {userDetails.displayLanguage === "ar" ? (
                                                                <div className="absolute top-0 left-0 w-32 h-32 bg-gradient-to-bl from-blue-400/20 to-transparent rounded-br-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                                            ) : (
                                                                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-blue-400/20 to-transparent rounded-bl-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                                            )}

                                                            <div className="relative z-10">
                                                                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 mb-3">
                                                                    <h3 className="text-xl md:text-2xl font-bold text-blue-300 group-hover:text-blue-200 transition">{exp.role}</h3>
                                                                ...
                                                                <p className="text-blue-400 font-semibold mb-3 text-lg">{exp.company}</p>
                                                                <div className={`mt-3 p-4 bg-slate-900/50 rounded-lg  border-blue-500/50 ${userDetails.displayLanguage === "ar" ? "border-r-4" : "border-l-4"}`}>
                                            ...
                                            <div className="max-w-5xl mx-auto">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                                    {userDetails.skills.map((skill, i) => (
                                                        <div key={i} className="group relative p-5 rounded-xl bg-gradient-to-br from-blue-500/10 to-blue-500/10 border border-blue-500/30 hover:border-blue-500/60 hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 cursor-pointer overflow-hidden">
                                                            ...
                                                            <p className="text-gray-200 group-hover:text-blue-200 transition font-medium relative z-10">{skill}</p>
                                                        </div>
                                                    ))}
                                                </div>
                                            </div>
                                    ...
                                    projects: userDetails.projects && userDetails.projects.length > 0 && (
                                        <section key="projects" id="projects" className="mb-20 scroll-mt-24">
                                            <div className="max-w-5xl mx-auto">
                                                <div className="flex items-center gap-4 mb-8">
                                                    <Briefcase size={32} className="text-blue-400" /> {/* Assuming Briefcase for projects, or a different icon if preferred */}
                                                        ...
                                                        >
                                                            <div className="md:flex">
                                                                ...
                                                                <div className={`py-6 flex-1 px-6 group-hover:px-8 transition-all duration-300`}>
                                                                    <h3 className="text-2xl font-bold text-blue-300 mb-3 group-hover:text-blue-200 transition">{project.title}</h3>
                                  ...
                                  `}
                                                                    ...
                                                                    <div className="flex flex-wrap gap-2 mb-6">
                                                                        {project.technologies?.map((tech, i) => (
                                                                            <span
                                                                                key={i}
                                                                                className="px-3 py-1 bg-blue-500/20 border border-blue-500/40 rounded-full text-xs text-blue-300"
                                                                            >
                                                                                {tech}
                                                                            </span>
                                                                        ))}
                                                                    ...
                                                                    {project.link && (
                                                                        <a
                                                                            ...
                                                                            className="inline-flex items-center gap-2 px-6 py-2 bg-blue-600/20 hover:bg-blue-600/40 border border-blue-500/50 rounded-lg text-blue-300 transition-all duration-300 font-medium"
                                                                        >
                                                                            <Globe size={18} />
                                                                            {t('viewProject')}
                                                                        </a>
                                            ...
                                            <div className="max-w-5xl mx-auto">
                                                ...
                                                <div className="space-y-6">
                                                    {userDetails.education.map((edu, i) => (
                                                        <div
                                                            key={i}
                                                            className="group relative p-6 bg-gradient-to-br from-blue-500/10 to-blue-500/10 border border-blue-500/30 rounded-xl hover:border-blue-500/60 hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300 overflow-hidden"
                                                        >
                                                            ...
                                                            <div className="relative z-10">
                                                                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 mb-3">
                                                                    <h3 className="text-xl md:text-2xl font-bold text-blue-300 group-hover:text-blue-200 transition">{edu.degree}</h3>
                                                                    <p className="text-gray-400 text-sm md:text-base whitespace-nowrap">
                                                                        {edu.startYear} - {edu.endYear}
                                                                    </p>
                                                                </div>

                                                                <p className="text-blue-400 font-semibold text-lg mb-3">{edu.school}</p>

                                                                {edu.field && (
                                                                    <div className={`p-4 bg-slate-900/50 rounded-lg ${userDetails.displayLanguage === "ar" ? "border-r-4" : "border-l-4"} border-blue-500/50`}>
                                            ...
                                            <div className="max-w-5xl mx-auto">
                                                ...
                                                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                                    {userDetails.certificates.map((cert, i) => (
                                                        <div
                                                            key={i}
                                                            className="group relative bg-gradient-to-br from-blue-500/10 to-blue-500/10 border border-blue-500/30 rounded-xl hover:border-blue-500/60 hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300 overflow-hidden flex flex-col"
                                                        >

                                                            {cert.cfimage && (
                                                                <div className="relative h-56 w-full bg-slate-900/50 overflow-hidden cursor-pointer border-b border-blue-500/20 flex items-center justify-center p-4 z-10" onClick={() => setSelectedImage(cert.cfimage)}>
                                                                    <Image
                                                                        src={cert.cfimage}
                                            ...
                                            <div className="max-w-5xl mx-auto">
                                                ...
                                                <div className="flex flex-wrap gap-4">
                                                    {userDetails.languages.map((lang, i) => (
                                                        <div
                                                            key={i}
                                                            className="group relative px-6 py-3 bg-gradient-to-br from-blue-500/10 to-blue-500/10 border border-blue-500/30 rounded-full text-gray-200 hover:border-blue-500/60 hover:text-blue-200 transition-all duration-300 cursor-pointer overflow-hidden"
                                                        >
                                                            <div className="absolute inset-0 bg-gradient-to-r from-blue-500/0 via-blue-500/10 to-blue-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full"></div>
                                ...
                                <section
                                    ...
                                    <div className="max-w-5xl mx-auto">
                                        <div className="flex items-center gap-3 mb-8">
                                            <Share2 className="text-blue-400" size={30} />
                                            ...
                                            {[
                                                ...
                                                .map((item, i) => (
                                                    <a
                                                        ...
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                        className="group relative p-3 bg-gradient-to-br from-blue-500/10 to-blue-500/10 border border-blue-500/30 rounded-xl hover:border-blue-500/60 hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 overflow-hidden"
                                                    >
                                                        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/0 via-blue-500/10 to-blue-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        ...
                        {/* Footer */}
                        <footer className="border-t border-blue-500/20 bg-slate-950/50 backdrop-blur-md mt-12">
                    ...
                    <button
                        onClick={scrollToTop}
                        className={`fixed bottom-8 right-8 z-40 p-3 bg-blue-500/20 backdrop-blur-md border border-blue-500/30 text-white rounded-full shadow-2xl hover:bg-blue-500/40 hover:scale-110 transition-all duration-300 group ${showScrollTop ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0 pointer-events-none'}`}
                    >
                        <ArrowUp size={24} />
                    </button>
                </div>
