...
export default function ThemeSeven({ userDetails, userLinks, bgcolor }) {
                    ...
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-red-500/20 rounded-lg text-white transition-all duration-300 backdrop-blur-md border border-white/10 hover:border-red-500/50"
                            >
                                {copied ? <CheckCircle2 className="text-red-400" /> : <Copy />}
                            </button>
                            {/* QR Code */}
                            <div
                                            ...
                                            <div className="flex flex-col md:flex-row">
                                                {project.image && (
                                                    <div className="md:w-1/3 relative overflow-hidden h-64 md:h-auto">
                                                        ...
                                                        />
                                                        <div className="absolute inset-0 bg-gradient-to-r from-red-900/50 to-transparent mix-blend-multiply"></div>
                                                    </div>
                                                )}
