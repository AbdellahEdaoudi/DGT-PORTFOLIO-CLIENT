    ...
    return (
        ...
        >
            ...
            <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
                <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-orange-600/10 rounded-full mix-blend-screen filter blur-[100px] opacity-30 animate-blob"></div>
                <div
                    className="absolute top-0 right-0 w-[500px] h-[500px] bg-amber-600/10 rounded-full mix-blend-screen filter blur-[100px] opacity-30 animate-blob"
                    style={{ animationDelay: "2s" }}
                ></div>
                <div
                    className="absolute -bottom-32 left-1/3 w-[600px] h-[600px] bg-red-500/10 rounded-full mix-blend-screen filter blur-[100px] opacity-30 animate-blob"
            ...
            <div className="relative z-10 px-4 md:px-8 max-w-6xl mx-auto">
                ...
                <header className="pt-8 pb-10">
                    ...
                    <div className="flex justify-between items-center mb-8">
                        <h1 className="text-white text-2xl font-bold cursor-pointer hover:text-orange-400 transition-colors">
                        ...
                        <div className="flex gap-3">
                            ...
                            <div
                                ...
                                className="flex items-center gap-2 px-2 bg-white/10 hover:bg-orange-500/20 rounded-lg text-white transition-all duration-300 backdrop-blur-md border border-white/10 hover:border-orange-500/50 cursor-pointer"
                            >
                                <QrcodeProfile userDetails={userDetails} />
                            </div>
                            {/* User Links */}
                            <div className="flex items-center gap-2 px-2 bg-white/10 hover:bg-orange-500/20 rounded-lg text-white transition-all duration-300 backdrop-blur-md border border-white/10 hover:border-orange-500/50">
                    ...
                    <div className="flex flex-col-reverse md:flex-row gap-10 items-center justify-between mb-8">
                        <div className={`flex-1 text-center  ${userDetails?.displayLanguage === 'ar' ? 'md:text-right' : 'md:text-left'}`}>
                            ...
                            <p className="text-2xl md:text-3xl font-bold text-orange-300/90 mb-6 flex items-center justify-center md:justify-start gap-2">
                        ...
                        <div className="relative group">
                            <div className="absolute -inset-1 bg-gradient-to-r from-orange-600 to-amber-600 rounded-[2rem] blur opacity-40 group-hover:opacity-75 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
                        ...
                        <div className="animate-fadeIn">
                            ...
                            {activeTab === "about" && (
                                <div className="grid md:grid-cols-2 gap-4 md:gap-8">
                                    <div className="bg-white/5 backdrop-blur-md rounded-3xl p-5 md:p-8 border border-white/10 hover:border-orange-500/30 transition-all duration-300">
                                        <h3 className="text-2xl mb-6 flex items-center gap-2 text-white">
                                            <User className="text-orange-400" /> {t('aboutMe')}
                                        </h3>
                                            ...
                                            {userDetails.email && (
                                                <div className="flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-white/5 rounded-2xl overflow-hidden">
                                                    ...
                                                    <div className="min-w-0">
                                                        ...
                                                        <a href={`mailto:${userDetails.email}`} className="text-white hover:text-orange-300 transition break-all text-sm md:text-base">
                                                            {userDetails.email}
                                                        </a>
                                                    </div>
                                                </div>
                                    ...
                                    {userDetails?.languages?.length > 0 && (
                                        <div className="bg-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/10 hover:border-orange-500/30 transition-all duration-300">
                                            <h3 className="text-2xl mb-6 flex items-center gap-2 text-white">
                                                <Globe className="text-amber-400" /> {t('languages')}
                                            </h3>
                            ...
                            {activeTab === "services" && (
                                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {userDetails.services?.map((service, i) => (
                                        <div
                                            key={i}
                                            className="group p-6 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl hover:bg-white/10 hover:border-orange-500/50 transition-all duration-300 hover:-translate-y-1"
                                        >
                                            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-orange-500/20 to-amber-500/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                            ...
                            {activeTab === "projects" && (
                                <div className="space-y-8">
                                    {userDetails.projects?.map((project, i) => (
                                        <div
                                            key={i}
                                            className="group bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl overflow-hidden hover:border-orange-500/30 transition-all duration-500"
                                        >
                                            <div className="flex flex-col md:flex-row">
                                                {project.image && (
                                                    <div className="md:w-1/3 relative overflow-hidden h-64 md:h-auto">
                                                        ...
                                                        />
                                                        <div className="absolute inset-0 bg-gradient-to-r from-orange-900/50 to-transparent mix-blend-multiply pointer-events-none"></div>
                                                    </div>
                                                )}
                                                <div className="flex-1 p-4 md:p-8">
                                                    <div className="flex justify-between items-start mb-4">
                                                        <h3 className="text-2xl font-semibold text-white group-hover:text-orange-300 transition-colors">
                                                            {project.title}
                                                        </h3>
                                                        {project.link && (
                                                            <a
                                                                ...
                                                                target="_blank"
                                                                rel="noreferrer"
                                                                className="p-2 bg-white/10 rounded-full hover:bg-orange-500 hover:text-white transition-all duration-300"
                                                            >
                                                                <Globe size={20} />
                                                            </a>
                                                        )}
                            ...
                            {activeTab === "experience" && (
                                <div className="grid gap-6">
                                    {userDetails.experience?.map((exp, i) => (
                                        <div key={i} className="p-5 md:p-6 bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 hover:border-orange-500/30 transition-all duration-300">
                                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-orange-400 text-sm">{exp.company}</div>
                                                    </div>
                                                </div>
                                                <span className="text-xs px-3 py-1 rounded-full bg-amber-500/10 text-amber-300 border border-amber-500/20 whitespace-nowrap">
                            ...
                            {activeTab === "education" && (
                                <div className="grid md:grid-cols-2 gap-6">
                                    {userDetails.education?.map((edu, i) => (
                                        <div
                                            key={i}
                                            className="relative p-4 md:p-8 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl hover:border-orange-500/30 transition-all duration-300 group overflow-hidden"
                                        >
                                            ...
                                            <div className="relative z-10">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <span className="inline-block px-3 py-1 mb-4 text-xs text-orange-300 bg-orange-500/10 rounded-full border border-orange-500/20">
                            ...
                            {activeTab === "certificates" && (
                                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {userDetails.certificates?.map((cert, i) => (
                                        <div
                                            key={i}
                                            className="relative bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl overflow-hidden hover:border-orange-500/30 transition-all duration-300 group flex flex-col"
                                        >
                                            {cert.cfimage && (
