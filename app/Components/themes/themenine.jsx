...
export default function ThemeNine({ userDetails, userLinks, bgcolor }) {
                    ...
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-orange-500/20 rounded-lg text-white transition-all duration-300 backdrop-blur-md border border-white/10 hover:border-orange-500/50"
                            >
                                {copied ? <CheckCircle2 className="text-orange-400" /> : <Copy />}
                            </button>
                            {/* QR Code */}
                            <div
                                ...
                                <div className="grid md:grid-cols-2 gap-4 md:gap-8">
                                    <div className="bg-white/5 backdrop-blur-md rounded-3xl p-5 md:p-8 border border-white/10 hover:border-orange-500/30 transition-all duration-300">
                                        <h3 className="text-2xl mb-6 flex items-center gap-2 text-white">
                                            <User className="text-orange-400" /> Personal Info
                                        </h3>
                                    ...
                                    {userDetails?.languages?.length > 0 && (
                                        <div className="bg-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/10 hover:border-orange-500/30 transition-all duration-300">
                                            <h3 className="text-2xl mb-6 flex items-center gap-2 text-white">
                                                <Globe className="text-amber-400" /> Languages
                                            </h3>
                                            ...
                                            <div className="flex flex-col md:flex-row">
                                                {project.image && (
                                                    <div className="md:w-1/3 relative overflow-hidden h-64 md:h-auto">
                                                        ...
                                                        />
                                                        <div className="absolute inset-0 bg-gradient-to-r from-orange-900/50 to-transparent mix-blend-multiply"></div>
                                                    </div>
                                                )}
