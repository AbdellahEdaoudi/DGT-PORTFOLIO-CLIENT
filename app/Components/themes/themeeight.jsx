    ...
    return (
        ...
        >
            ...
            <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
                <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-yellow-600/10 rounded-full mix-blend-screen filter blur-[100px] opacity-30 animate-blob"></div>
                <div
                ...
                ></div>
                <div
                    className="absolute -bottom-32 left-1/3 w-[600px] h-[600px] bg-yellow-500/10 rounded-full mix-blend-screen filter blur-[100px] opacity-30 animate-blob"
            ...
            <div className="relative z-10 px-4 md:px-8 max-w-6xl mx-auto">
                ...
                <header className="pt-8 pb-10">
                    ...
                    <div className="flex justify-between items-center mb-8">
                        <h1 className="text-white text-2xl font-bold cursor-pointer hover:text-yellow-400 transition-colors">
                    ...
                    <div className="flex flex-col-reverse md:flex-row gap-10 items-center justify-between mb-8">
                        <div className={`flex-1 text-center  ${userDetails?.displayLanguage === 'ar' ? 'md:text-right' : 'md:text-left'}`}>
                            <div className="inline-block px-3 py-1 mb-4 text-xs tracking-wider text-yellow-300 uppercase bg-yellow-500/10 rounded-full border border-yellow-500/20">
                                Welcome to my world
                            </div>
                            <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight leading-tight text-white">
                                {userDetails?.fullname}
                            </h1>
                            <p className="text-2xl md:text-3xl font-bold text-yellow-300/90 mb-6 flex items-center justify-center md:justify-start gap-2">
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex items-center gap-2 px-4 py-2 md:px-5 md:py-2.5 rounded-xl transition-all duration-300 whitespace-nowrap text-sm md:text-base ${activeTab === tab.key
                                                ? "bg-gradient-to-r from-yellow-600 to-amber-600 text-white shadow-lg shadow-yellow-500/25"
                        ...
                        <div className="animate-fadeIn">
                            ...
                            {activeTab === "about" && (
                                <div className="grid md:grid-cols-2 gap-4 md:gap-8">
                                    <div className="bg-white/5 backdrop-blur-md rounded-3xl p-5 md:p-8 border border-white/10 hover:border-yellow-500/30 transition-all duration-300">
                                    ...
                                    {userDetails?.languages?.length > 0 && (
                                        <div className="bg-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/10 hover:border-yellow-500/30 transition-all duration-300">
                                            <h3 className="text-2xl mb-6 flex items-center gap-2 text-white">
                            ...
                            {activeTab === "services" && (
                                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {userDetails.services?.map((service, i) => (
                                        <div
                                            key={i}
                                            className="group p-6 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl hover:bg-white/10 hover:border-yellow-500/50 transition-all duration-300 hover:-translate-y-1"
                                        >
                                            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-yellow-500/20 to-amber-500/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                            ...
                            {activeTab === "projects" && (
                                <div className="space-y-8">
                                    {userDetails.projects?.map((project, i) => (
                                        <div
                                            key={i}
                                            className="group bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl overflow-hidden hover:border-yellow-500/30 transition-all duration-500"
                                        >
                                            <div className="flex flex-col md:flex-row">
                                                {project.image && (
                                                    <div className="md:w-1/3 relative overflow-hidden h-64 md:h-auto">
                                                        ...
                                                        />
                                                        <div className="absolute inset-0 bg-gradient-to-r from-yellow-900/50 to-transparent mix-blend-multiply pointer-events-none"></div>
                                                    </div>
                                                )}
                                                <div className="flex-1 p-4 md:p-8">
                                                    <div className="flex justify-between items-start mb-4">
                                                        <h3 className="text-2xl font-semibold text-white group-hover:text-yellow-300 transition-colors">
                                                            {project.title}
                                                        </h3>
                                                        {project.link && (
                                                            <a
                                                                ...
                                                                target="_blank"
                                                                rel="noreferrer"
                                                                className="p-2 bg-white/10 rounded-full hover:bg-yellow-500 hover:text-white transition-all duration-300"
                                                            >
                                                                <Globe size={20} />
                                                            </a>
                                                        )}
                            ...
                            {activeTab === "experience" && (
                                <div className="grid gap-6">
                                    {userDetails.experience?.map((exp, i) => (
                                        <div key={i} className="p-5 md:p-6 bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 hover:border-yellow-500/30 transition-all duration-300">
                                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-yellow-400 text-sm">{exp.company}</div>
                                                    </div>
                                                </div>
                            ...
                            {activeTab === "education" && (
                                <div className="grid md:grid-cols-2 gap-6">
                                    {userDetails.education?.map((edu, i) => (
                                        <div
                                            key={i}
                                            className="relative p-4 md:p-8 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl hover:border-yellow-500/30 transition-all duration-300 group overflow-hidden"
                                        >
                                            ...
                                            <div className="relative z-10">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <span className="inline-block px-3 py-1 mb-4 text-xs text-yellow-300 bg-yellow-500/10 rounded-full border border-yellow-500/20">
                            ...
                            {activeTab === "certificates" && (
                                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {userDetails.certificates?.map((cert, i) => (
                                        <div
                                            key={i}
                                            className="relative bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl overflow-hidden hover:border-yellow-500/30 transition-all duration-300 group flex flex-col"
                                        >
                                            {cert.cfimage && (
