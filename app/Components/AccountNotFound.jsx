...
export default function AccountNotFound() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#1e2124] overflow-hidden relative">
      ...
      <footer className="hidden bg-[#2a2e32] text-center py-4 text-gray-400 text-sm z-10">
        <p>© {new Date().getFullYear()} DGT Portfolio. All rights reserved.</p>
      </footer>
    </div>
  )
}