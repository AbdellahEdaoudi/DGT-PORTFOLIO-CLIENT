              ...
              >
                <div className="flex-grow">
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none transition bg-white ${validationErrors[index]?.company ? 'border-red-500 ring-1 ring-red-100' : 'border-gray-300 focus:ring-2 focus:ring-amber-500'}`}
                  />
                ...
                <div className="p-3 md:p-4 border-t border-gray-100 space-y-3 bg-gray-50/50 animate-in fade-in slide-in-from-top-1 duration-200">
                  ...
                  <div>
                    <input
                      ...
                      className={`w-full px-3 py-2 border rounded-lg focus:outline-none transition bg-white ${validationErrors[index]?.role ? 'border-red-500 ring-1 ring-red-100' : 'border-gray-300 focus:ring-2 focus:ring-amber-500'}`}
                    />
                  ...
                  <div>
                    <textarea
                      ...
                      className={`w-full px-3 py-2 border rounded-lg focus:outline-none h-20 transition bg-white ${validationErrors[index]?.description ? 'border-red-500 ring-1 ring-red-100' : 'border-gray-300 focus:ring-2 focus:ring-amber-500'}`}
                    />
