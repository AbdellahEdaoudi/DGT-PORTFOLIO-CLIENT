    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-black text-white overflow-hidden">
            ...
            <Navbar>
                <div className=" mx-auto md:mx-3 px-6 py-6 flex justify-between items-center">
                    ...
                    <AuthButtons labels={{
                        ...
                        businessLinks: "Enlaces de Negocios",
                        support: "Soporte",
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            <h1 className="text-6xl md:text-7xl font-bold leading-tight">
                                ...
                                <br />
                                <span className="text-white">Elevado</span>
                            </h1>
                            <p className="text-lg  text-gray-300 leading-relaxed">
                                Sin código, sin complicaciones. Construye un portafolio limpio y moderno en minutos. <br />
                                Muestra tu carrera, habilidades, proyectos y enlaces de trabajo como nunca antes.
                                Deja una impresión duradera y desbloquea nuevas oportunidades.
                        ...
                        <div className="flex gap-4">
                            <Link href={"/update-profile"} className="px-8 py-4 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-full font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition flex items-center gap-2">
                                Comenzar a Construir <ArrowRight className="w-5 h-5" />
                            </Link>
            ...
            <section id="Features" className="px-6 pt-8 pb-8 md:py-12 border-t border-purple-500/20">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-5xl font-bold mb-4">¿Por qué elegir DGT Portfolio?</h2>
                        <p className="text-gray-400 max-w-2xl mx-auto">
                            Todo lo que necesitas para mostrar tu mejor trabajo y conseguir las oportunidades de tus sueños
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description: "Crea portafolios impresionantes sin escribir una sola línea de código",
                            },
                            {
                                icon: SquareMousePointer,
                                title: "Subdominio Personalizado",
                                description: (
                                    <>Obtén un subdominio personalizado como <strong>tu-nombre.dgtportfolio.com</strong> para tu portafolio</>
                                ),
                            },
                            {
                                icon: QrCode,
                                title: "Perfil con Código QR",
                                description: (
                                    <>Genera un código QR para tu portafolio que puedes descargar o compartir al instante</>
                                ),
                            },
                            {
                                icon: Layout,
                                title: "Múltiples Temas",
                                description: "Elige entre diferentes temas para personalizar el aspecto de tu portafolio",
                            },
                            {
                                icon: Share2,
                                title: "Fácil Compartir Enlaces",
                                description: "Comparte el enlace de tu portafolio en cualquier lugar con un solo clic",
                            },
                            {
                                icon: Zap,
                                title: "Rápido como el Rayo",
                                description: "Tiempos de carga ultrarrápidos que mantienen a los visitantes comprometidos",
                            },
                        ].map((feature, i) => (
                            <div
                                key={i}
            ...
            <section id="pricing" className="px-6 py-20 border-t border-purple-500/20">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-400 max-w-2xl mx-auto">
                            Elige el plan perfecto para tu portafolio creativo
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        {[
                            {
                                name: "Plan Mensual",
                                description: "$10 por el mes siguiente",
                                price: "$1",
                                period: "/primer mes",
                            ...
                            {
                                name: "Plan de 4 Meses",
                                description: "Gran oferta a medio plazo",
                                price: "$30",
                                period: "/4 meses",
                                cta: "Suscribirse 4 Meses",
                                highlight: false,
                            },
                            {
                                name: "Plan Anual",
            ...
            <section className="px-6 py-20 border-t border-purple-500/20">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="bg-gradient-to-br from-purple-600/20 to-pink-600/20 border border-purple-500/50 rounded-3xl p-12">
                        <h2 className="text-2xl md:text-5xl font-bold mb-6">¿Listo para mostrar tu talento?</h2>
                        <p className=" md:text-xl text-gray-300 mb-8">
                            Únete a miles de creadores que construyen sus portafolios de ensueño hoy
                        </p>
                        <Link className="text-sm md:text-base" href={"/update-profile"}>
                            <button
                                ...
                                Crea Tu Portafolio <ArrowRight className="w-5 h-5" />
                            </button>
                        </Link>
                    </div>
                </div>
            ...
            <footer className="border-t border-purple-500/20 px-6 py-12 text-gray-400 text-center">
                <p> © {new Date().getFullYear()} <span className="font-semibold">DGT Portfolio</span>. Todos los derechos reservados.</p>
            </footer>
        </div>
    )
}
