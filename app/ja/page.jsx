...
export const metadata = {
    ...
    description: "コード不要、手間いらず。数分でクリーンでモダンなポートフォリオを作成。キャリア、スキル、プロジェクト、仕事のリンクをこれまでにない方法で紹介。",
    openGraph: {
        title: "DGT Portfolio - プロフェッショナルなポートフォリオをオンラインで作成",
        description: "コード不要、手間いらず。数分でクリーンでモダンなポートフォリオを作成。",
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-black text-white overflow-hidden">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            <h1 className="text-6xl md:text-7xl font-bold leading-tight">
                                ...
                                <br />
                                <span className="text-white">さらなる高みへ</span>
                            </h1>
                            <p className="text-lg  text-gray-300 leading-relaxed">
                                コード不要、手間いらず。数分でクリーンでモダンなポートフォリオを作成。<br />
                                キャリア、スキル、プロジェクト、仕事のリンクをこれまでにない方法で紹介。
                                印象に残るポートフォリオで、新しいチャンスを掴みましょう。
                        ...
                        <div className="flex gap-4">
                            <Link href={"/update-profile"} className="px-8 py-4 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-full font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition flex items-center gap-2">
                                作成を開始 <ArrowRight className="w-5 h-5" />
                            </Link>
            ...
            <section id="Features" className="px-6 pt-8 pb-8 md:py-12 border-t border-purple-500/20">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-5xl font-bold mb-4">DGT Portfolioが選ばれる理由</h2>
                        <p className="text-gray-400 max-w-2xl mx-auto">
                            最高の作品を披露し、夢のチャンスを掴むために必要なすべてがここに
                        </p>
                    </div>
                        ...
                        {[
                            {
                                icon: Code2,
                                title: "コード不要のデザイン",
                                description: "コードを1行も書かずに素晴らしいポートフォリオを作成",
                            },
                            {
                                icon: SquareMousePointer,
                                title: "カスタムサブドメイン",
                                description: (
                                    <><strong>yourname.dgtportfolio.com</strong>のようなカスタムサブドメインを取得</>
                                ),
                            },
                            {
                                icon: QrCode,
                                title: "QRコードプロフィール",
                                description: (
                                    <>ダウンロードや共有がすぐにできるポートフォリオ用QRコードを生成</>
                                ),
                            },
                            {
                                icon: Layout,
                                title: "豊富なテーマ",
                                description: "様々なテーマから選んで、ポートフォリオの見た目をカスタマイズ",
                            },
                            {
                                icon: Share2,
                                title: "簡単なリンク共有",
                                description: "ワンクリックでどこでもポートフォリオのリンクを共有",
                            },
                            {
                                icon: Zap,
                                title: "超高速",
                                description: "訪問者を惹きつける超高速な読み込み時間",
                            },
                        ].map((feature, i) => (
                            <div
                                key={i}
            ...
            <section id="pricing" className="px-6 py-20 border-t border-purple-500/20">
                <div className="max-w-6xl mx-auto">
                    {/* Header */}
                    <div className="text-center mb-16">
                        <h2 className="text-5xl font-bold mb-4">シンプルで透明な価格設定</h2>
                        <p className="text-gray-400 max-w-2xl mx-auto">
                            あなたのクリエイティブなポートフォリオに最適なプランを選んでください
                        </p>
                    </div>
            ...
            <section className="px-6 py-20 border-t border-purple-500/20">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="bg-gradient-to-br from-purple-600/20 to-pink-600/20 border border-purple-500/50 rounded-3xl p-12">
                        <h2 className="text-2xl md:text-5xl font-bold mb-6">才能を披露する準備はできましたか？</h2>
                        <p className=" md:text-xl text-gray-300 mb-8">
                            今日から夢のポートフォリオを作成している何千人ものクリエイターに参加しましょう
                        </p>
                        <Link className="text-sm md:text-base" href={"/update-profile"}>
                            <button
                                ...
                                ポートフォリオを作成 <ArrowRight className="w-5 h-5" />
                            </button>
                        </Link>
                    </div>
                </div>
